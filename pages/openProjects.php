<?php
	...
	$rows = $mysqli->query("SELECT * FROM clientprojects WHERE clientId = ".$clientId." AND archiveProj = '0'");
	...
	$sqlStmt = "SELECT
				...
				WHERE clientprojects.clientId = ".$clientId." AND clientprojects.archiveProj = '0'
...
<div class="contentAlt">
	<ul class="nav nav-tabs">
		<li class="active"><a href="#open" data-toggle="tab"><i class="fa fa-folder-open-o"></i> <?php echo $openProjectsLink; ?></a></li>
...
<div class="content last">
	...
	<div class="tab-content">
		<div class="tab-pane in active no-padding" id="open">
			<?php if(mysqli_num_rows($res) < 1) { ?>
				<div class="alertMsg default no-margin">
					<i class="fa fa-minus-square-o"></i> <?php echo $noOpenProjMsg; ?>
				</div>
			<?php } else { ?>
