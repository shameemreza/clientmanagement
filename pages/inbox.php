<?php
	...
	if (isset($_POST['submit']) && $_POST['submit'] == 'replyToMessage') {
		...
		if ($_POST['messageTitle'] == '') {
			...
			$subject = $replyMsgEmailSubject.' '.$clientFullName;
			...
			if (mail($theEmail, $subject, $message, $headers)) {
				$msgBox = alertBox($replySentConf, "<i class='fa fa-check-square'></i>", "success");
			} else {
				$msgBox = alertBox($emailErrorMsg, "<i class='fa fa-times-circle'></i>", "danger");
			}
			// Clear the Form of values
    ...
    $res = mysqli_query($mysqli, $query) or die('-4'.mysqli_error());
...
<div class="contentAlt">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="#inbox" data-toggle="tab" class="showinbox"><i class="fa fa-inbox"></i> <?php echo $inboxLink; ?></a></li>
		<li><a href="index.php?page=sent"><i class="fa fa-share"></i> <?php echo $sentItemsLink; ?></a></li>
		<li><a href="index.php?page=archived"><i class="fa fa-archive"></i> <?php echo $archiveLink; ?></a></li>
		...
		<div class="tab-pane in active" id="inbox">
			...
			<?php if(mysqli_num_rows($res) < 1) { ?>
				<div class="alertMsg default no-margin">
					<i class="fa fa-minus-square-o"></i> <?php echo $noInboxMsg; ?>
				</div>
			<?php } else { ?>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header modal-primary">
												...
												<h4 class="modal-title"><?php echo $sendReplyText; ?></h4>
											</div>
			...
			<form action="" method="post">
				<div class="form-group">
					<?php
						...
						$mgrres = mysqli_query($mysqli, $getMgrs) or die('-5'.mysqli_error());
					?>
	...
	<div class="content last">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p class="msgQuip text-muted no-margin"><?php echo $selectInboxMsgText; ?></p>
