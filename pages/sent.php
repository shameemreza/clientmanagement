<?php
	...
	if (isset($_POST['submit']) && $_POST['submit'] == 'deleteMsg') {
		...
		$stmt = $mysqli->prepare("UPDATE privatemessages SET toRead = 1, fromDeleted = 1 WHERE messageId = ?");
	...
	$rows = $mysqli->query("
		...
		WHERE
			privatemessages.clientId = ".$clientId." AND
...
<div class="contentAlt">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#sent" data-toggle="tab" class="showsent"><i class="fa fa-share"></i> <?php echo $sentItemsLink; ?></a></li>
		<li class=""><a href="index.php?page=archived"><i class="fa fa-archive"></i> <?php echo $archiveLink; ?></a></li>
		...
		<div class="tab-pane in active" id="sent">
			...
			<?php if(mysqli_num_rows($res) < 1) { ?>
				<div class="alertMsg default no-margin">
					<i class="fa fa-minus-square-o"></i> <?php echo $noSentMsg; ?>
				</div>
			<?php } else { ?>
	...
	<div class="content last">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p class="msgQuip text-muted no-margin"><?php echo $selectSentMsgText; ?></p>
