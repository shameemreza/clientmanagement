	...
	if (isset($_POST['submit']) && $_POST['submit'] == 'editEvent') {
		...
		if($_POST['eventTitle'] == '') {
			...
			if ($uId == $clientId) {
				...
				$msgBox = alertBox($editEventErrorMsg, "<i class='fa fa-times-circle'></i>", "danger");
			}
		}
	}
...
<div class="content last">
	...
	<div id="calendar"></div>
	<p class="cal-quip text-muted"><?php echo $clickEventText; ?></p>
</div>
			...
			<form action="" method="post">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="eventColor"><?php echo $eventColorField; ?></label>
								...
								<span class="help-block"><?php echo $eventColorFieldHelp; ?></span>
							</div>
						</div>
					</div>
					<div class="form-group">
				...
				<div class="modal-footer">
					...
					<input type="hidden" name="uId" class="client-id" value="" />
			...
			<form action="" method="post">
				<div class="modal-body">
					<div class="form-group">
						...
						<select class="form-control" name="isShared" id="isShared">
				...
				<div class="modal-footer">
					<button type="input" name="submit" value="newEvent" class="btn btn-success btn-icon"><i class="fa fa-check-square-o"></i> <?php echo $saveNewEventBtn; ?></button>
					<button type="button" class="btn btn-default btn-icon" data-dismiss="modal"><i class="fa fa-times-circle-o"></i> <?php echo $cancelBtn; ?></button>
				</div>
			</form>
