<?php
	...
	if (isset($_POST['submit']) && $_POST['submit'] == 'reopenTask') {
		...
		$taskStatus = $reopenedText;
		$dateClosed = date("0000-00-00 00:00:00");
		...
		$stmt->bind_param('sss', $taskStatus, $dateClosed, $reopenId);
		$stmt->execute();
...
<div class="contentAlt">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#closed" data-toggle="tab"><i class="fa fa-check-circle"></i> <?php echo $closedTasksTabLink; ?></a></li>
		...
		<div class="tab-pane in active no-padding" id="closed">
			<?php if(mysqli_num_rows($res) < 1) { ?>
				<div class="alertMsg default no-margin">
					<i class="fa fa-minus-square-o"></i> <?php echo $noClosedFound; ?>
				</div>
			<?php } else { ?>
				<table class="rwd-table no-margin">
					<tbody>
						<tr class="primary">
							...
							<th><?php echo $completedOnText; ?></th>
							<th></th>
						</tr>
						<?php while ($row = mysqli_fetch_assoc($res)) { ?>
							<tr>
								...
								</td><td data-th="<?php echo $projectText; ?>">
								...
								<td data-th="<?php echo $completedOnText; ?>"><?php echo $row['dateClosed']; ?></td>
								<td data-th="<?php echo $actionsText; ?>">
									...
									<a data-toggle="modal" href="#completeTask<?php echo $row['taskId']; ?>">
										<i class="fa fa-history text-success" data-toggle="tooltip" data-placement="left" title="<?php echo $reopenTaskTooltip; ?>"></i>
									</a>
									...
									<div class="modal-content">
										<form action="" method="post">
											<div class="modal-body">
												<p class="lead"><?php echo $reopenTaskTooltip.': '.clean($row['taskTitle']); ?>?</p>
											</div>
											<div class="modal-footer">
												<input name="reopenId" type="hidden" value="<?php echo $row['taskId']; ?>" />
