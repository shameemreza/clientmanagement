...
<div class="contentAlt">
	...
	<ul class="nav nav-tabs">
		...
		<li class=""><a href="index.php?action=sent"><i class="fa fa-share"></i> <?php echo $sentTabLink; ?></a></li>
		<li class="active"><a href="#archive" data-toggle="tab" class="showarchive"><i class="fa fa-archive"></i> <?php echo $archiveTabLink; ?></a></li>
	...
	<div class="content last">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p class="msgQuip text-muted no-margin"><?php echo $selectArchivedMsgQuip; ?></p>
