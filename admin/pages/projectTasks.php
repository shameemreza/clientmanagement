<?php
	...
	$query = "SELECT
			...
			WHERE
				tasks.projectId != 0 AND tasks.adminId = ".$adminId." AND tasks.isClosed = 0
			ORDER BY
...
<div class="contentAlt">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#project" data-toggle="tab"><i class="fa fa-folder-open"></i> <?php echo $projectTaskTabLink; ?></a></li>
...
<div class="content last">
	...
	<div class="tab-content">
		<div class="tab-pane in active no-padding" id="project">
			<?php if(mysqli_num_rows($res) < 1) { ?>
				<div class="alertMsg default no-margin">
					<i class="fa fa-minus-square-o"></i> <?php echo $noProjectFound; ?>
				</div>
			<?php } else { ?>
