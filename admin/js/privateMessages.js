$(function() {
	...
	// Set the Selects based on who the PM is sent to
	$('#toMgr').change(function() {
		$('#toClt option:first').prop('selected',  true);
	});
	
	$('#toClt').change(function() {
		$('#toMgr option:first').prop('selected',  true);
	});
